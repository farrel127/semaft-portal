    ...
    <footer class="bg-semaft-navy text-gray-300 pt-16 pb-8 border-t-[6px] border-semaft-gold mt-auto relative">
        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                ...
                <div class="space-y-5">
                    <a href="{{ url('/') }}" class="flex items-center gap-3 mb-4 group inline-flex">
            ...
            <div class="border-t border-white/10 pt-6 mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400 font-medium text-center md:text-left">
                <p>&copy; {{ date('Y') }} Senat Mahasiswa Fakultas Teknik USB YPKP. All rights reserved.</p>
                <p class="flex items-center justify-center gap-1.5 hover:text-gray-300 transition-colors">
                    Designed with <i class="fa-solid fa-heart text-red-500 animate-pulse"></i> by <span class="font-bold text-white tracking-wider">vicnitnizzmt</span>.
                </p>
            </div>
        </div>
    </footer>
