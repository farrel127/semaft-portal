            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gray-50 p-6 md:px-12 text-center border-t border-gray-100 mt-4">
                    ...
                    <div class="flex justify-center gap-4 mt-3">
                        <button class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white transition flex items-center justify-center"><i class="fa-brands fa-whatsapp"></i></button>
                        <button class="w-10 h-10 rounded-full bg-blue-100 text-blue-500 hover:bg-blue-500 hover:text-white transition flex items-center justify-center"><i class="fa-brands fa-twitter"></i></button>
                        <button class="w-10 h-10 rounded-full bg-gray-200 text-gray-600 hover:bg-gray-600 hover:text-white transition flex items-center justify-center"><i class="fa-solid fa-link"></i></button>
                    </div>
                </div>
